...
public class ObjectFactory {
    ...
    private final static QName _GetReleve_QNAME = new QName("http://IIBDCC.ma/", "getReleve");
    private final static QName _GetReleveResponse_QNAME = new QName("http://IIBDCC.ma/", "getReleveResponse");
    private final static QName _Releve_QNAME = new QName("http://IIBDCC.ma/", "releve");
     ...
     */
    @XmlElementDecl(namespace = "http://IIBDCC.ma/", name = "getReleve")
     ...
     */
    @XmlElementDecl(namespace = "http://IIBDCC.ma/", name = "getReleveResponse")
     ...
     */
    @XmlElementDecl(namespace = "http://IIBDCC.ma/", name = "releve")
